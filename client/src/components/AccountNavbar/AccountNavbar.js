...
export default function AccountNavbar({ user,activeNav,setActiveNav,setSubmitPopup }) {
  ...
  return (
    <div className='accountNavbar'>
      <div className="accountNavbar__content">
        ...
        <div className={`accountNavbar__addNewOffer accountNavbar__item ${activeNav === 'newOffer' && 'accountNavbar__item--active'}`} onClick={() => setActiveNav('newOffer')}>
        ...
        <div className={`accountNavbar__myOffers accountNavbar__item ${activeNav === 'myOffers' && 'accountNavbar__item--active'}`} onClick={() => setActiveNav('myOffers')}>
        ...
        <div className={`accountNavbar__favorites accountNavbar__item ${activeNav === 'favorites' && 'accountNavbar__item--active'}`} onClick={() => setActiveNav('favorites')}>
        ...
        <div className={`accountNavbar__setting accountNavbar__item ${activeNav === 'settings' && 'accountNavbar__item--active'}`} onClick={() => setActiveNav('settings')}>
